/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 78fbccd652284918112ccf7ed917377a)
// Runtime types generated with workerd@1.20260124.0 2026-01-18 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ClickCounter";
	}
	interface Env {
		KV: KVNamespace;
		DB: D1Database;
		...
		CLICK_COUNTER: DurableObjectNamespace<import("./src/worker").ClickCounter>;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "DOMAIN" | "BETTER_AUTH_SECRET" | "BETTER_AUTH_URL" | "TRUSTED_ORIGINS">> {}
}
